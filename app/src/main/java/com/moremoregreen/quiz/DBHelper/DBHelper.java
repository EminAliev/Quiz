package com.moremoregreen.quiz.DBHelper;
...
public class DBHelper extends SQLiteAssetHelper {
    ...
    public List<Question> getQuestion(int category) {
        SQLiteDatabase db = instance.getWritableDatabase();
        ...
        if (cursor.moveToFirst()) {
            while (!cursor.isAfterLast()) {
                Question questions1 = new Question(cursor.getInt(cursor.getColumnIndex("ID")),
