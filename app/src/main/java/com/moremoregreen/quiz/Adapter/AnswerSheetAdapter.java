...
import com.moremoregreen.quiz.R;
...
public class AnswerSheetAdapter extends RecyclerView.Adapter<AnswerSheetAdapter.MyViewHolder> {
    ...
    public AnswerSheetAdapter(Context context, List<CurrentQuestion> currentQuestions) {
        ...
        this.currentQuestionList = currentQuestions;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        if (currentQuestionList.get(i).getType() == Common.ANSWER_TYPE.RIGHT_ANSWER)
            myViewHolder.question_item.setBackgroundResource(R.drawable.grid_qustion_right_answer);
